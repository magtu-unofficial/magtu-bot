...
export const reportTextArg = {
  name: "Сообщение об ошибку",
  query: `Коротко опишите проблему, которая у вас возникла или просто перешлите сообение в котором содержиться ощибка. Для отмены напишите "Отмена"`,
